...
public class BoardMapperTests {
	 ...
	 * log.info("testRead() ========================================"); BoardVO
	 * board = boardMapper.read(2L);
	 * 
	 * log.info(board); System.out.println("testRead() : " + board.toString());
	 * 
	 * }
	 * 
	 * @Test public void testDelete() {
	 * log.info("testDelete() ========================================"); int count
	 ...
	 * log.info("testUpdate()================================");
	 * 
	 * BoardVO board = new BoardVO(); board.setContent("내용 수정");
	 * board.setTitle("제목 수정"); board.setBno(2L); board.setWriter("modifer");
	 * 
