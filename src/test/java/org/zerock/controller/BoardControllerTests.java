...
// 스프링에서는 WebApplicationContext를 이용하기 위해
@WebAppConfiguration
...
public class BoardControllerTests {
	...
	// 테스트를 위한 URL, 파라미터 등을 브라우저에서 사용하는 것처럼 만들기 위한 객체
	 ...
	 * "5")).andReturn() .getModelAndView().getViewName(); log.info(resultPage); }
	 * 
	 ...
	 * "bno", "5")).andReturn() .getModelAndView().getModelMap()); }
	 * 
	 ...
	 * "5").param("title", "수정된 테스트 새글 제목") .param("content",
